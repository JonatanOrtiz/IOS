...
//  TestConstraints
//
//  Created by Jonatan Eduardo de Araujo on 08/06/21.
//
...
public extension UIView {
    ...
    @discardableResult
    func customAnchor(centerX: (anchor: NSLayoutXAxisAnchor, constant: CGFloat)? = nil,
                    ...
                    anchorHeight: (anchor: NSLayoutDimension, multiplier: CGFloat, constant: CGFloat)? = nil) -> CustomConstraint {
        self.translatesAutoresizingMaskIntoConstraints = false
        
        var constraint = CustomConstraint()
    ...
    @discardableResult
    func customAnchorTopToSafeArea(of view: UIView, constant: CGFloat = 0.0) -> NSLayoutConstraint? {
    ...
    @discardableResult
    func customAnchorFillSuperview(constant: CGFloat = 0.0, inSafeArea: Bool = false) -> CustomConstraint {
        var constraint = CustomConstraint()
        if let superview = superview {
            if inSafeArea {
                if #available(iOS 11.0, *) {
                    constraint = customAnchor(
